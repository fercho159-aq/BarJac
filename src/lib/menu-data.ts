...
export const drinkItems = [
    ...
    { name: "Beverly hills iced tea", quantity: "180 ml", price: "135.00", ingredients: "Smirnoff, Beefetear, Bacardi blanco, Jose cuervo tradicional, Controy, Jarabe natural, Jugo de limon amarillo, Cinzano to spritz, Gajo de limon amarillo" },
    { name: "Long beach iced tea", quantity: "180 ml", price: "135.00", ingredients: "Smirnoff, Beefetear, Bacardi blanco, Jose cuervo tradicional, Controy, Jarabe natural, Jugo de limon amarillo, Jugo de arándano, Gajo de limon amarillo" },
