...
import { breakfastItems, entranceItems, foodItems, drinkItems, snackItems, sodaItems } from "@/lib/menu-data";
            ...
            <Tabs defaultValue="desayunos" className="w-full">
              ...
              <TabsContent value="cerveza">
                 <div className="text-center py-10">
                  <p className="text-muted-foreground">La sección de Cerveza estará disponible próximamente.</p>
                </div>
              </TabsContent>
            </Tabs>
          </div>
